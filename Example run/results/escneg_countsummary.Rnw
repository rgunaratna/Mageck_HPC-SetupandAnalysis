...
library(xtable)
filelist=c("ERR376998.subsample.fastq","ERR376999.subsample.fastq");
labellist=c("plasmid","ESC1");
reads=c(100000,100000);
mappedreads=c(89828,88887);
totalsgrnas=c(87437,87437);
zerocounts=c(40817,45017);
giniindex=c(0.5695368567432515,0.6138870713257354);
...
genboxplot("escneg.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=4.5,height=4.5>>=
genhistplot("escneg.count_normalized.txt");
@
...
genpcaplot("escneg.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=4.5,height=4.5>>=
genclustering("escneg.count_normalized.txt");
@
